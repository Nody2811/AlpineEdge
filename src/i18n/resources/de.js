    ...
    translation: {
      ...
      contactSection: {
        ...
        form: {
          ...
          error: `Bitte versuchen sie es nochmals oder kontaktieren sie uns unter: <a href="#">`,
          name: {
            label: "Name",
          ...
          email: {
            label: "E-mail oder Telefonnumer",
          ...
          message: {
            ...
            error: {
              empty: "Nachricht ist erforderlich",
            },
          },
          submit: {
            loading: "Lädt...",
